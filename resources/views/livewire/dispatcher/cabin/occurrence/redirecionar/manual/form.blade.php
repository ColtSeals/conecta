                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-lg-1">
                                    <x-success-button
                                        class="btn-app btn-block w-100 btn-lg mt-1"
                                        wire:click="$dispatch('show-modal', { modal: 'modal-occurrence-redirect-automatic' })"
                                        title="{{ __('Clique para Redirecionar com dados do endereço') }}"
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <x-info-button
                                        class="btn-app btn-block w-100 btn-lg mt-1"
                                        wire:click="$dispatch('show-modal', { modal: 'modal-occurrence-redirect-automatic' })"
                                        title="{{ __('Clique para Selecionar Rádio Patrulha') }}"
                                        data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                    >
                                        <span class="mdi mdi-car-emergency mdi-24px me-1"></span> {{ __('Rádio Patrulha') }}
                                    </x-info-button>
                                </div>
                                ...
                                <div class="col-sm-12 col-lg-3">
                                    <x-warning-button
                                        ...
                                        data-bs-placement="top"
                                    >
                                        <span class="mdi mdi-shield-plus mdi-24px me-1"></span> {{ __('OUTRO SERVIÇO') }}
                                    </x-warning-button>
