                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input id="plate" wire:model="fullName" type="text" maxlength="161" placeholder="{{ __('Digite o nome completo') }}" required />
                ...
                <div class="col-12">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            ...
                            <x-label required>{{ __('Número do IMEI') }}</x-label>
                        </div>
                    </div>
                </div>
