                ...
                <div class="card-body p-2">
                    <div class="d-flex flex-column justify-content-center align-items-center">
                        <x-success-button
                                ...
                                wire:click="$dispatch('showModal', { alias: 'dispatcher.cabin.occurrence.create.form', maxWidth: 'xl' })"
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap text-center">
                    <table class="table table-hover">
                        ...
                        <div>@if(!empty($occurrencesWithPatrol))
                                @foreach($occurrencesWithPatrol as $occurrence)
                                    ...
                                    <tr x-data @click="if ($event.target.type !== 'checkbox' && window.getSelection().toString().length === 0)
                                     @this.call('showCommitted', '{{ $occurrence->id }}')"
                                    >
