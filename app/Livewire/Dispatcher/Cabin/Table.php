...
namespace App\Livewire\Dispatcher\Cabin;
...
class Table extends Component
{
    ...
    public $search, $currentPage = 1, $sortOrder = 'desc';
 ...
 'occurrenceUpdated' => 'handleOccurrenceUpdated'];
    ...
    {
        $this->dispatch('showModal', alias: 'dispatcher.cabin.occurrence.create.form', maxWidth: '2xl');
    }
    ...
    public function render(): View
    {
        ...
        // Busca todos os dados de uma vez em vez de paginar
        $occurrences = $query->get();

        return view('livewire.dispatcher.cabin.table', ['occurrences' => $occurrences]);
    }
