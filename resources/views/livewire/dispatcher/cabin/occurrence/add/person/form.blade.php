            ...
            <div class="row gy-4">
                <div class="col-sm-12 col-lg-3">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input id="rg" wire:model="rg" type="text" maxlength="12" placeholder="{{ __('Digite a RG') }}" required />
                ...
                <div class="col-sm-12 col-lg-3">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input id="cpf" wire:model="cpf" type="text" maxlength="14" placeholder="{{ __('Digite a CPF') }}" required />
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input wire:model="fullName" type="text" maxlength="161" placeholder="{{ __('Digite o nome completo') }}" required />
                ...
                <div class="col-sm-12 col-lg-9">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input wire:model="fullName" type="text" maxlength="161" placeholder="{{ __('Digite o nome da Mãe') }}" required />
                ...
                <div class="col-sm-12 col-lg-9">
                    <div class="input-group input-group-merge">
                        ...
                        <div class="form-floating form-floating-outline">
                            <x-input wire:model="fullName" type="text" maxlength="161" placeholder="{{ __('Digite o nome do Pai') }}" required />
                ...
                <div class="col-12">
                    <div class="form-floating form-floating-outline ">
                        <textarea class="form-control" placeholder="{{ __('Digite Dados do Individuo') }}" style="height: 60px;" aria-label="historyOccurrence"></textarea>
