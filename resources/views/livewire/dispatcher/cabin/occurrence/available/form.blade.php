                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-lg-3">
                                    <button type="button" class="btn btn-lg btn-success btn-app btn-block w-100" wire:click="showModal('modal-previous-occurrences')" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Clique para Verificar Ocorrências Anteriores">
                                        M-10200
                                    </button>
                                </div>
